...
if (!function_exists('curl_init')) {
  throw new Exception('FacebookOauth needs the CURL PHP extension.');
}
if (!function_exists('json_decode')) {
  throw new Exception('FacebookOauth needs the JSON PHP extension.');
}
...
/**
 * Provides access to the FacebookOauth Platform.
 *
 * @author Naitik Shah <naitik@facebook.com>
 */
class FacebookOauth {
