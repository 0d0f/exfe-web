  ...
  var userMenuTpls = {
      normal: ''
        + '<div class="dropdown-menu user-panel">'
          ...
          + '<div class="body">'
            + '{{#unless password}}'
            + '<div class="merge set-up">'
              + '<a href="#" data-source="{{default_identity.external_username}}" data-widget="dialog" data-dialog-type="setpassword">Set Up</a> your <span class="x-sign">EXFE</span> password'
            + '</div>'
            + '{{/unless}}'
            + '{{#if verifying}}'
    ...
    , browsing_identity: ''
        + '<div class="dropdown-menu user-panel">'
          ...
          + '<div class="body">'
            ...
            + '{{#if ../setup}}'
            + '<div class="merge set-up">'
              + '<a href="#" data-source="{{default_identity.external_username}}" data-widget="dialog" data-dialog-type="identification" data-dialog-tab="d02">Set Up</a> new <span class="x-sign">EXFE</span> account with the browsing identity.'
            + '</div>'
            + '{{/if}}'
            + '{{/with}}'
            + '{{#if normal}}'
