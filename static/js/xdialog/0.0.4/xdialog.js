        ...
        others: ''
          + '<div class="isee d d03 hide">'
            + '<div class="modal-body">'
              ...
              + '<p>Tired of signing up all around? Just authorize through your existing accounts from other websites, such as Twitter, Facebook, <span class="strike">Google, etc.</span> (soon to support)</p>'
