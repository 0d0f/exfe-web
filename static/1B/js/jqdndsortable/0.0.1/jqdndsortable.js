  ...
  !function ( $ ) {
    ...
    $.fn.dndsortable = function (options) {
      ...
      return this.each(function () {
        ...
        $this
          // dragstart
          .on('dragstart.ui', options.items, function (e) {
            e.stopPropagation();
          ...
          // dragend
          .on('dragend.ui', options.items, function (e) {
            e.stopPropagation();
          ...
          // dragenter
          .on('dragenter.ui', options.items, function (e) {
          ...
          // dragleave
          .on('dragleave.ui', options.items, function (e) {
            // Prevent dragenter on a child from allowing a dragleave on the container
            var prevCounter = dragenterData(this);
            dragenterData(this, prevCounter - 1);
          ...
          // drop
          .on('drop.ui', options.items, function (e) {
            e.stopPropagation();
            e.preventDefault();
          ...
          // dragover
          .on('dragover.ui', options.items, function (e) {
            if (!dragging) {
              return true;
            }
            e.stopPropagation();
