  ...
  var newbieGuide = [
    ...
    '<div class="newbie nbg-1">'
      ...
      + '<ul class="unstyled hide">'
        + '<li>&radic; Set account password for security.</li>'
        + '<li>&radic; Set a portrait that your friends can recognize.</li>'
        + '<li>&radic; Add more frequently used identities that may use for gathering.</li>'
        + '</ul>'
